                        ...
                        <div class="game_product_body">
                            ...
                            <div class="game_product_description">
                                ...
                                @if ($typeGames->games->getPrice() == 0)
                                    <span
                                        class="game_product_price text-light">Free</span>
                                @else
                                    @if (!$typeGames->games->getDiscount() == 0)
                                        <span
                                            class="badge bg-primary me-3">{{ $typeGames->games->getDiscount() . '%' }}</span>
                                        <span
                                            class="game_product_price text-secondary text-decoration-line-through">
                                            <span>₫{{ number_format($typeGames->games->getPrice(), 0, '.', ',') }}</span>
                                        </span>
                                    @endif
