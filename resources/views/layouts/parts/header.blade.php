<header class="fixed-top sticky-top">
                    ...
                    @else
                        <div id="dropdown"
                            ...
                            <button type="button"
                                ...
                                <span
                                    class="ms-1">{{ auth()->user()->getName() }}</span>
                            </button>
    ...
    <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1"
        id="navOffCanvas" aria-labelledby="navOffCanvasLabel">
        ...
        <div class="offcanvas-body">
            ...
            @else
                ...
                <div class="offcanvas-item">
                    <form class="flex-grow-1" action="{{ route('logout') }}"
                        id="logout" method="POST">
                        <a role="button"
                            class="text-capitalize offcanvas-link text-light"
                            onclick="document.getElementById('logout').submit()">
    ...
    <div class="container-fluid bg-black text-white">
        <div class="headnav">
            <div class="container-md">
                <div
                    class="wrapper_headnav d-flex d-inline-flex justify-content-between my-4 my-md-5">
                    <div>
                        <button
                            class="btn btn-outline-secondary text-light display-2 fs-4 d-block d-md-none"
                            type="button" data-bs-toggle="offcanvas"
