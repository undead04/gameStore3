...
@section('table')
    <form action="{{ route('admin.game.store') }}" method="post"
        class="w-75 mx-auto data_form" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="flex-grow-1">
                <input name="developer" value="{{ old('developer') }}"
        ...
        <div class="form-group">
            ...
            <div class="flex-grow-1">
                <input class="form-control bg-transparent text-light" type="file"
                    name="image">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control bg-transparent text-light" name="description"
